...
const Header = () => {
  ...
  return (
    <header className="bg-myblue p-2 text-white flex justify-center ">
      <nav className="w-full max-w-7xl mt-4 mr-0 mb-[80px] ml-0 relative">
       ...
       p-3 absolute bottom-[-110px] w-full max-w-7xl text-black 
        "
        >
          ...
          <div className="flex items-center gap-1 cursor-pointer">
            ...
            {openOptions && (
              <div className="flex absolute flex-col gap-3 rounded-sm top-[40px] shadow-md bg-white text-black p-3">
